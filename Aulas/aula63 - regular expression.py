...
#cpf = '746.824.890-70'.replace('.', '').replace('-', '')#replace muda algo por algo que eu coloque no argumento, pode ser usado quantas vezes você quiser.
cpf = re.sub(r'[^0-9]', '','asdasd746.82dsffsd4.890-fsgsdfg70')#com o acento ^, pega tudo que não está entre 0 e 9 e muda pra isso ''
intera = 0
